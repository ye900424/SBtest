...
//        System.out.println(JSON.toJSONString(test.largestRectangleArea(new int[]{2,1,5,6,2,3})));
        System.out.println(JSON.toJSONString(test.largestRectangleArea(new int[]{2,4})));
    }
