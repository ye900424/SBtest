...
public class App {
    ...
    public static String aliyunhost = "39.105.17.168";

    public static void main(String[] args) throws InterruptedException {

        // 第一步：与canal进行连接
        CanalConnector connector = CanalConnectors.newSingleConnector(new InetSocketAddress(aliyunhost, 11111),
                "example", "canal", "");
        connector.connect();
        ...
        while (true) {
            try {
                // 每次读取 1000 条
                Message message = connector.getWithoutAck(20);
